...
namespace TF1 {
	...
	/// <summary>
	/// Resumen de Game_Over
	/// </summary>
	public ref class Game_Over : public System::Windows::Forms::Form
	{
	public:
		Game_Over(void)
		{
			...
			//pnl_Suprema->BackColor = System::Drawing::Color::FromArgb(0, 50, 50, 50);//hace traslucido el panel
			//lblMensaje->BackColor = System::Drawing::Color::FromArgb(0, 255, 255, 255); //hace traslucido el mensaje del aliado
			//lblNombre->ForeColor = Color::FromArgb(0, 220, 20, 60); 
			...
			dialogosIA_Suprema = gcnew cli::array<System::String^>(4) {
				"JAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJA",
					"JAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJA",
					"JAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJAJA",
					"QUEDARÁS ENCERRADO POR EL RESTO DE LA ETERNIDAD!"
			};
			opacidad = 0;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Game_Over::typeid));
			...
			this->timer1->Tick += gcnew System::EventHandler(this, &Game_Over::timer1_Tick);
			// 
			// panel1
			// 
			...
			this->timer2->Tick += gcnew System::EventHandler(this, &Game_Over::timer2_Tick);
			// 
			// pnl_Suprema
			// 
			...
			this->nivel1->Click += gcnew System::EventHandler(this, &Game_Over::nivel1_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &Game_Over::button1_Click);
			// 
			// Game_Over
			// 
